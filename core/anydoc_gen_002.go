...
func (m *Module) fn44(v0 int32) int32 {
	var v1 int32
	t0 := m.g0
	v1 = t0 - i32(16)
	m.g0 = v1
	...
	m.fn45(i32(1284296), i32(43), v1+i32(15), i32(1067436), i32(1067500))
	panic("unreachable")
}
func (m *Module) fn45(v0, v1, v2, v3, v4 int32) {
	var v5 int32
	t0 := m.g0
	v5 = t0 - i32(32)
	m.g0 = v5
	...
	m.fn31(i32(1052636), v5+i32(16), v4)
	panic("unreachable")
}
func (m *Module) fn46(v0 int32) {
	...
	m.fn31(i32(1066505), v1+i32(16), i32(1078268))
	panic("unreachable")
}
...
l3:
	...
	l4:
		t13 := v2 + i32(6)
		v3 = v3 + i32(-1)
		t14 := int32(m.memory[int64(uint32(v0<<1))+1100104])
		m.memory[uint32(t13+v3)] = byte(t14)
	}
l5:
	t15 := m.fn683(v1, i32(1), i32(1), i32(0), v2+i32(6)+v3, i32(10)-v3)
	v3 = t15
	m.g0 = v2 + i32(16)
	return v3
}
func (m *Module) fn48(v0, v1, v2 int32) {
	...
	m.fn31(i32(1066454), v3+i32(16), v2)
	panic("unreachable")
}
...
func (m *Module) fn52(v0, v1, v2 int32) int32 {
	var v3 int32
	{
		{
			t0 := int32(load32(m.memory[uint32(v0):]))
...
func (m *Module) fn53(v0, v1 int32) int32 {
...
func (m *Module) fn54(v0, v1, v2 int32) int32 {
	t0 := m.fn49(v0, i32(1067552), v1, v2)
	return t0
}
...
func (m *Module) fn56(v0, v1, v2, v3 int32) int32 {
	...
	v5 = i32(1)
	{
		...
		l7:
			...
			l11:
				m.fn41(v0, v1, v8, v7, i32(1122532))
				panic("unreachable")
			l17:
				v5 = i32(1)
				goto l0
	...
	l26:
		m.fn41(v0, v1, v8, v9, i32(1122548))
		panic("unreachable")
	}
l0:
	m.g0 = v4 + i32(16)
...
func (m *Module) fn57(v0, v1, v2 int32) {
	var v3 int32
	{
		if v2 != 0 {
			goto l0
					...
					l25:
						{
							...
							t53 := m.fn61(t50, t51, t52-v14<<4+i32(-16))
							v7 = int32(t53)
							v10 = t49 & v7
...
func (m *Module) fn61(v0, v1 int64, v2 int32) int64 {
	var v3, v4 int32
...
func (m *Module) fn65(v0, v1 int32) int32 {
	var v2, v3, v4, v5, v6, v7, v8 int32
	var v9 int64
	var v10, v11 int32
	var v12, v13 int64
...
func (m *Module) fn68(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
...
func (m *Module) fn85(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
