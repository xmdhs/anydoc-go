...
func (m *Module) fn42(v0, v1, v2, v3, v4 int32) {
	var v5 int32
	t0 := m.g0
	v5 = t0 - i32(32)
	m.g0 = v5
	...
	m.fn28(i32(1052636), v5+i32(16), v4)
	panic("unreachable")
}
func (m *Module) fn43(v0 int32) {
	var v1 int32
	var v2 int64
	t0 := m.g0
	v1 = t0 - i32(32)
	...
	m.fn28(i32(1067143), v1+i32(16), i32(1078900))
	panic("unreachable")
}
...
l3:
	...
	l4:
		t13 := v2 + i32(6)
		v3 = v3 + i32(-1)
		t14 := int32(m.memory[int64(uint32(v0<<1))+1100736])
		m.memory[uint32(t13+v3)] = byte(t14)
	}
l5:
	t15 := m.fn681(v1, i32(1), i32(1), i32(0), v2+i32(6)+v3, i32(10)-v3)
	v3 = t15
	m.g0 = v2 + i32(16)
	return v3
}
func (m *Module) fn45(v0, v1, v2 int32) {
	...
	m.fn28(i32(1067092), v3+i32(16), v2)
	panic("unreachable")
}
func (m *Module) fn46(v0, v1, v2, v3 int32) int32 {
...
func (m *Module) fn51(v0, v1, v2 int32) int32 {
	t0 := m.fn46(v0, i32(1068188), v1, v2)
	return t0
}
...
func (m *Module) fn53(v0, v1, v2, v3 int32) int32 {
	...
	v5 = i32(1)
	{
		...
		l7:
			...
			l11:
				m.fn38(v0, v1, v8, v7, i32(1123164))
				panic("unreachable")
			l17:
				v5 = i32(1)
				goto l0
	...
	l26:
		m.fn38(v0, v1, v8, v9, i32(1123180))
		panic("unreachable")
	}
l0:
	m.g0 = v4 + i32(16)
					...
					l25:
						{
							...
							t53 := m.fn58(t50, t51, t52-v14<<4+i32(-16))
							v7 = int32(t53)
							v10 = t49 & v7
...
func (m *Module) fn58(v0, v1 int64, v2 int32) int64 {
	var v3, v4 int32
...
func (m *Module) fn60(v0, v1 int32) int32 {
	var v2, v3, v4, v5, v6, v7, v8 int32
	var v9 int64
	var v10, v11 int32
	var v12, v13 int64
...
func (m *Module) fn61(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
...
func (m *Module) fn65(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
...
func (m *Module) fn66(v0, v1, v2 int32) int32 {
...
func (m *Module) fn82(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
						...
						l9:
							{
								...
								t20 := v12
								v1 = int32(uint32(int64(bits.TrailingZeros64(uint64(v9))))>>3) + v3
								t21 := m.fn87(t18, t19, t20+(i32(0)-v1)*i32(24)+i32(-24))
								v7 = int32(t21)
								v10 = t17 & v7
