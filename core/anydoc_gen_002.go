...
func (m *Module) fn42(v0 int32) int32 {
	...
	{
		t0 := int32(m.memory[int64(uint32(int32(uint32(v0)>>10)))+1098453])
		t1 := int32(m.memory[int64(uint32(t0<<4|int32(uint32(v0)>>6)&i32(15)))+1106704])
		v1 = t1
		if uint32(v1) < uint32(i32(57)) {
			t6 := int64(load64(m.memory[int64(uint32(v1<<3))+1106248:]))
			v3 = t6
			goto l4
		}
		v2 = v1 + i32(-57)
		if uint32(v1) >= uint32(i32(79)) {
			m.fn39(v2, i32(22), i32(1098880))
			panic("unreachable")
		}
		v1 = v2 << 1
		t2 := int32(m.memory[int64(uint32(v1))+1106200])
		t3 := int64(load64(m.memory[int64(uint32(t2<<3))+1106248:]))
		v2 = i32_shl(i32(1), v2)
		p4 := i64(-1)
		if v2&i32(2047998) != 0 {
			p4 = i64(0)
		...
		v3 = t3 ^ p4
		t5 := int32(m.memory[int64(uint32(v1))+1106201])
		v4 = int64(uint32(t5))
...
func (m *Module) fn43(v0 int32) int32 {
	...
	{
		t0 := int32(m.memory[int64(uint32(int32(uint32(v0)>>10)))+1098576])
		t1 := int32(m.memory[int64(uint32(t0<<4|int32(uint32(v0)>>6)&i32(15)))+1107432])
		v1 = t1
		if uint32(v1) < uint32(i32(44)) {
			t6 := int64(load64(m.memory[int64(uint32(v1<<3))+1107080:]))
			v3 = t6
			goto l4
		}
		v2 = v1 + i32(-44)
		if uint32(v1) >= uint32(i32(69)) {
			m.fn39(v2, i32(25), i32(1098880))
			panic("unreachable")
		}
		v1 = v2 << 1
		t2 := int32(m.memory[int64(uint32(v1))+1107024])
		t3 := int64(load64(m.memory[int64(uint32(t2<<3))+1107080:]))
		v2 = i32_shl(i32(1), v2)
		p4 := i64(-1)
		...
		v3 = t3 ^ p4
		t5 := int32(m.memory[int64(uint32(v1))+1107025])
		v4 = int64(uint32(t5))
		if v2&i32(4258818) == 0 {
			v3 = i64_shr_u(v3, v4)
			goto l4
...
func (m *Module) fn44(v0, v1, v2, v3, v4 int32) {
	m.fn866(v0, v1, v2, v3, v4)
	panic("unreachable")
}
func (m *Module) fn45(v0 int32) {
	var v1, v2, v3 int32
	t0 := m.g0
	v1 = t0 - i32(16)
	m.g0 = v1
...
func (m *Module) fn47(v0 int32) int32 {
	...
	m.fn48(i32(1284336), i32(43), v1+i32(15), i32(1067544), i32(1067608))
	panic("unreachable")
}
func (m *Module) fn48(v0, v1, v2, v3, v4 int32) {
	var v5 int32
	t0 := m.g0
	v5 = t0 - i32(32)
	m.g0 = v5
	...
	store64(m.memory[int64(uint32(v5))+24:], uint64(int64(uint32(i32(9)))<<32|int64(uint32(v5+i32(8)))))
	store64(m.memory[int64(uint32(v5))+16:], uint64(int64(uint32(i32(10)))<<32|int64(uint32(v5))))
	m.fn34(i32(1052553), v5+i32(16), v4)
	panic("unreachable")
}
func (m *Module) fn49(v0 int32) {
	var v1 int32
	var v2 int64
	t0 := m.g0
	v1 = t0 - i32(32)
	...
	m.fn34(i32(1066565), v1+i32(16), i32(1078372))
	panic("unreachable")
}
func (m *Module) fn50(v0, v1, v2 int32) {
	var v3 int32
	var v4 int64
	t0 := m.g0
	v3 = t0 - i32(32)
	...
	m.fn34(i32(1066514), v3+i32(16), v2)
	panic("unreachable")
}
func (m *Module) fn51(v0, v1, v2, v3 int32) int32 {
...
func (m *Module) fn52(v0, v1 int32) int32 {
	t0 := int32(load32(m.memory[uint32(v1):]))
	t1 := int32(load32(m.memory[int64(uint32(v1))+4:]))
	t2 := int32(load32(m.memory[int64(uint32(t1))+12:]))
...
func (m *Module) fn56(v0, v1, v2 int32) int32 {
	t0 := m.fn51(v0, i32(1067660), v1, v2)
	return t0
}
func (m *Module) fn57(v0, v1 int32) int32 {
...
func (m *Module) fn58(v0, v1, v2, v3 int32) int32 {
	...
	v5 = i32(1)
	{
		...
		l7:
			...
			l11:
				m.fn44(v0, v1, v8, v7, i32(1122644))
				panic("unreachable")
			l17:
				v5 = i32(1)
				goto l0
	...
	l26:
		m.fn44(v0, v1, v8, v9, i32(1122660))
		panic("unreachable")
	}
l0:
	m.g0 = v4 + i32(16)
...
func (m *Module) fn62(v0, v1, v2 int32) int32 {
					...
					l25:
						{
							...
							t53 := m.fn64(t50, t51, t52-v14<<4+i32(-16))
							v7 = int32(t53)
							v10 = t49 & v7
...
func (m *Module) fn64(v0, v1 int64, v2 int32) int64 {
	var v3, v4 int32
...
func (m *Module) fn67(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
...
func (m *Module) fn71(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
	var v5, v6, v7, v8 int64
	t0 := m.g0
	v4 = t0 - i32(80)
...
func (m *Module) fn72(v0, v1, v2 int32) int32 {
...
func (m *Module) fn81(v0, v1 int32) int32 {
	var v2, v3, v4, v5, v6, v7, v8 int32
	var v9 int64
	var v10, v11, v12 int32
	var v13, v14 int64
...
func (m *Module) fn84(v0, v1, v2 int32) int32 {
...
func (m *Module) fn86(v0, v1 int32) int32 {
	var v2, v3, v4, v5, v6, v7, v8 int32
	var v9 int64
	var v10, v11 int32
	var v12, v13 int64
