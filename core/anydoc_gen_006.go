	...
	var v4, v5, v6, v7 int32
	{
		{
			{
				{
					if v3 == 0 {
						m.fn124(i32(1), i32(0), i32(0), i32(1271880))
						panic("unreachable")
					}
					v4 = v2 + i32(1)
			...
			l1:
				...
				if uint32(t2) > uint32(v3) {
					m.fn124(i32(0), v2, v3, i32(1271864))
					panic("unreachable")
				}
				v3 = i32(0)
				if v2 != 0 {
		...
		l11:
			...
			if uint32(v3) > uint32(v2) {
				m.fn124(i32(0), v3, v2, i32(1271848))
				panic("unreachable")
			}
			{
				{
...
func (m *Module) fn224(v0, v1, v2, v3 int32) {
...
func (m *Module) fn226(v0, v1, v2, v3 int32) {
	...
	m.g0 = v4
	{
		...
		if uint32(v5) <= uint32(i32(1)) {
			m.fn124(i32(2), v5, v3, i32(1271932))
			panic("unreachable")
		}
		if v3 == 0 {
			m.fn124(i32(2), v5, i32(0), i32(1271932))
			panic("unreachable")
		}
		v6 = v3 + i32(-3)
	...
	l3:
		...
		if uint32(v5) > uint32(v6) {
			m.fn124(i32(0), v5, v6, i32(1271900))
			panic("unreachable")
		}
		v6 = v5
		goto l2
		...
		{
			{
				...
				if v2 != 0 {
					...
					if uint32(v14) < uint32(v2) {
						m.fn124(v2, v14, v14, i32(1271916))
						panic("unreachable")
					}
					t16 := int32(load32(m.memory[int64(uint32(v1))+36:]))
					v13 = t16 + v2
...
func (m *Module) fn227(v0, v1, v2, v3, v4 int32) {
	var v5, v6, v7, v8, v9, v10 int32
	{
		{
			{
				...
				default:
					...
					m.fn124(i32(9), v4+i32(-3), v4, i32(1271948))
					panic("unreachable")
				case 1:
					v2 = i32(3)
					...
					if uint32(v4) <= uint32(i32(6)) {
						m.fn124(i32(4), v4+i32(-3), v4, i32(1271996))
						panic("unreachable")
					}
					v6 = v4 + i32(-7)
					if v6 != 0 {
				...
				case 2:
					...
					if uint32(v4) > uint32(i32(8)) {
						...
						v8 = v4 + i32(-1)
						if v4 == i32(9) {
							m.fn124(i32(9), v8, i32(9), i32(1272028))
							panic("unreachable")
						}
						{
							if v4 == i32(10) {
		...
		l5:
			...
			if uint32(v2) < uint32(i32(4)) {
				m.fn124(i32(4), v2, v4, i32(1271980))
				panic("unreachable")
			}
			v4 = v4 + i32(-7)
		l8:
	...
	{
		{
			...
			if uint32(t3) > uint32(v6) {
				m.fn124(i32(0), v5, v6, i32(1271848))
				panic("unreachable")
			}
	...
	l10:
		{
			...
			m.fn244(v4+i32(96), v4+i32(40), t22, t23)
			{
				{
					{
						{
									...
									l36:
										{
												...
												l42:
													{
														...
														}
														{
															...
															m.fn200(v4+i32(156), v1, i32(1), i32(4), i32(12))
											...
											l38:
												m.fn206(v4+i32(40), v23, v1, i32(1089297), i32(1))
												{
													v5 = v20 + i32(12)
							...
							l50:
								...
								m.fn242(v4+i32(144), v10, t91, t92, i32(0))
											...
											{
												{
													...
													if i32_shl(i32(1), v6)&i32(0x20000013) != 0 {
														...
														}
														{
															...
															m.fn247(v4+i32(96), v4+i32(180), v4+i32(156), v9, v1, i32(0), v5)
															...
															{
																{
																	...
																	if i32_shl(i32(1), v7)&i32(0x20000013) != 0 {
																		...
																		m.fn247(v4+i32(96), v4+i32(180), v4+i32(156), v9, v1, v22, v5+v22)
...
func (m *Module) fn230(v0 int32) {
	...
	v2 = p5
	m.fn211(t2, t4, t3, v2, i32(4), i32(44))
	{
		t6 := int32(load32(m.memory[int64(uint32(v1))+4:]))
		if t6 != i32(1) {
			goto l0
...
func (m *Module) fn231(v0, v1, v2, v3 int32) {
	var v4, v5, v6 int32
	{
		{
			p0 := v2 + i32(24)
...
func (m *Module) fn234(v0, v1 int32) int32 {
	...
	m.g0 = v2
	{
		...
		default:
			...
			t4 := int32(load32(m.memory[int64(uint32(v1))+4:]))
			t5 := m.fn49(t3, t4, i32(0x100c77), v2+i32(16))
			v1 = t5
			goto l7
		case 1:
			store32(m.memory[int64(uint32(v2))+4:], uint32(v0+i32(4)))
			...
			t8 := m.fn49(t6, t7, i32(1051487), v2+i32(16))
			v1 = t8
			goto l7
		case 2:
			...
			t11 := m.fn49(t9, t10, i32(1051290), v2+i32(16))
			v1 = t11
			goto l7
		case 3:
			store32(m.memory[int64(uint32(v2))+4:], uint32(v0+i32(4)))
			...
			t14 := m.fn49(t12, t13, i32(1052122), v2+i32(16))
			v1 = t14
			goto l7
		case 4:
			v3 = v0 + i32(4)
			{
				...
				if t15 != i32(2) {
					...
					t23 := m.fn49(t21, t22, i32(1052413), v2+i32(16))
					v1 = t23
					goto l7
				}
				...
				t20 := m.fn49(t18, t19, i32(1050647), v2+i32(16))
				v1 = t20
				goto l7
			}
		case 5:
			...
			v1 = t25
			{
				...
				default:
					...
					t27 := m.fn49(v1, v3, i32(1065772), v2+i32(16))
					v1 = t27
					goto l7
				case 1:
					...
					t28 := m.fn49(v1, v3, i32(1066986), v2+i32(16))
					v1 = t28
					goto l7
				case 2:
					store32(m.memory[int64(uint32(v2))+4:], uint32(v0+i32(8)))
					store64(m.memory[int64(uint32(v2))+16:], uint64(int64(uint32(i32(33)))<<32|int64(uint32(v2+i32(4)))))
					t29 := m.fn49(v1, v3, i32(1052289), v2+i32(16))
					v1 = t29
					goto l7
				case 3:
					t30 := int32(load32(m.memory[int64(uint32(v3))+12:]))
					t31 := m.t0[uint(t30)].(func(int32, int32, int32) int32)(v1, i32(1273467), i32(46))
					v1 = t31
					goto l7
				}
			}
		case 6:
			...
			v3 = t33
			{
				...
				default:
					...
					t36 := v3
					v5 = t35
					t37 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(t36, i32(1272368), i32(26))
					if t37 != 0 {
						goto l7
					}
					t38 := int32(load32(m.memory[int64(uint32(v0))+12:]))
					t39 := int32(load32(m.memory[int64(uint32(v0))+16:]))
					t40 := m.fn676(v3, v4, t38, t39)
					if t40 != 0 {
						goto l7
					}
					t41 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(v3, i32(1272267), i32(1))
					v1 = t41
					goto l7
				case 1:
					v1 = i32(1)
					...
					t43 := v3
					v5 = t42
					t44 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(t43, i32(1272394), i32(47))
					if t44 != 0 {
						goto l7
					}
					t45 := int32(load32(m.memory[int64(uint32(v0))+12:]))
					t46 := int32(load32(m.memory[int64(uint32(v0))+16:]))
					t47 := m.fn676(v3, v4, t45, t46)
					if t47 != 0 {
						goto l7
					}
					t48 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(v3, i32(1272267), i32(1))
					v1 = t48
					goto l7
				case 2:
					v1 = i32(1)
					...
					t50 := v3
					v5 = t49
					t51 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(t50, i32(1272441), i32(49))
					if t51 != 0 {
						goto l7
					}
					t52 := int32(load32(m.memory[int64(uint32(v0))+12:]))
					t53 := int32(load32(m.memory[int64(uint32(v0))+16:]))
					t54 := m.fn676(v3, v4, t52, t53)
					if t54 != 0 {
						goto l7
					}
					t55 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(v3, i32(1272267), i32(1))
					v1 = t55
					goto l7
				case 3:
					v1 = i32(1)
					...
					t57 := v3
					v5 = t56
					t58 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(t57, i32(0x136aaa), i32(22))
					if t58 != 0 {
						goto l7
					}
					t59 := int32(load32(m.memory[int64(uint32(v0))+12:]))
					t60 := int32(load32(m.memory[int64(uint32(v0))+16:]))
					t61 := m.fn676(v3, v4, t59, t60)
					if t61 != 0 {
						goto l7
					}
					t62 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(v3, i32(1272512), i32(59))
					v1 = t62
					goto l7
				case 4:
					v1 = i32(1)
					...
					t64 := v3
					v5 = t63
					t65 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(t64, i32(0x136aaa), i32(22))
					if t65 != 0 {
						goto l7
					}
					t66 := int32(load32(m.memory[int64(uint32(v0))+12:]))
					t67 := int32(load32(m.memory[int64(uint32(v0))+16:]))
					t68 := m.fn676(v3, v4, t66, t67)
					if t68 != 0 {
						goto l7
					}
					t69 := m.t0[uint(v5)].(func(int32, int32, int32) int32)(v3, i32(1272571), i32(52))
					v1 = t69
					goto l7
				case 5:
					store32(m.memory[int64(uint32(v2))+4:], uint32(v0+i32(8)))
					store64(m.memory[int64(uint32(v2))+16:], uint64(int64(uint32(i32(34)))<<32|int64(uint32(v2+i32(4)))))
					t70 := m.fn49(v3, v4, i32(1052762), v2+i32(16))
					v1 = t70
				}
			}
		}
...
func (m *Module) fn238(v0, v1 int32) int32 {
	t0 := int32(load32(m.memory[uint32(v0):]))
	t1 := m.fn258(t0, v1)
	return t1
}
...
func (m *Module) fn241(v0, v1, v2 int32) {
...
func (m *Module) fn242(v0, v1, v2, v3, v4 int32) {
			...
			l9:
				...
				if v6 != 0 {
					...
					if uint32(t12) < uint32(v5) {
						m.fn31(i32(1271708), i32(19), i32(1272140))
						panic("unreachable")
					}
					if uint32(v6) > uint32(v4-v5) {
						m.fn31(i32(1271708), i32(19), i32(1272156))
						panic("unreachable")
					}
		...
		l6:
			{
				...
				if uint32(t6) < uint32(v4) {
					m.fn31(i32(1271708), i32(19), i32(1271660))
					panic("unreachable")
				}
				if uint32(v5) > uint32(v9-v4) {
					m.fn31(i32(1271708), i32(19), i32(1271676))
					panic("unreachable")
				}
				if v5 != v3 {
					goto l2
...
func (m *Module) fn243(v0, v1, v2, v3 int32) {
	...
	l15:
		if uint32(v7) >= uint32(i32(0x7ffffff5)) {
			m.fn45(i32(1284296), i32(43), v4+i32(15), i32(1067436), i32(1067452))
			panic("unreachable")
		}
...
func (m *Module) fn244(v0, v1, v2, v3 int32) {
...
func (m *Module) fn245(v0, v1 int32) {
	...
	m.fn250(v2+i32(8), v1+i32(4))
	{
		...
		m.fn242(v2+i32(32), v1+i32(72), t8, t9, i32(1))
...
func (m *Module) fn246(v0, v1, v2, v3 int32) {
	var v4, v5, v6, v7 int32
	var v8, v9, v10 int64
	var v11 int32
	t0 := m.g0
	...
	l27:
		...
		switch t40 {
		case 1:
			m.fn7(i32(1273936), i32(40), i32(1145688))
			panic("unreachable")
		case 2:
			store32(m.memory[uint32(v0):], uint32(i32(-2)))
			if v1 == 0 {
...
func (m *Module) fn247(v0, v1, v2, v3, v4, v5, v6 int32) {
	...
	l7:
		...
		m.fn36(v6, v4, i32(1271548))
		panic("unreachable")
	}
l0:
	m.fn41(v3, v4, v5, v6, i32(1271532))
	panic("unreachable")
l8:
	{
...
l23:
	m.fn41(v3, v4, v10, v8, i32(1271564))
	panic("unreachable")
l26:
	if v5 != 0 {
		goto l27
			...
			{
				{
					...
					v2 = t32
					if v2 == i32(35) {
						m.fn628(v7+i32(8), v6+i32(1), v5+i32(-1))
						{
...
func (m *Module) fn248(v0, v1, v2 int32) {
	var v3 int32
	t0 := m.g0
	v3 = t0 - i32(16)
	m.g0 = v3
...
func (m *Module) fn249(v0 int32) {
	...
	v2 = p5
	m.fn211(t2, t4, t3, v2, i32(4), i32(32))
	{
		t6 := int32(load32(m.memory[int64(uint32(v1))+4:]))
		if t6 != i32(1) {
			goto l0
...
l7:
	...
	case 26:
		...
		goto l8
	case 10:
		t12 := int32(m.memory[int64(uint32(v2&i32(255)))+1139068])
		if t12&i32(2) == 0 {
			goto l9
		}
		goto l8
	default:
		...
		t13 := int32(m.memory[int64(uint32(v2&i32(255)))+1139068])
		if t13&i32(1) != 0 {
			goto l8
		}
		goto l9
...
func (m *Module) fn252(v0, v1 int32) {
	var v2, v3 int32
	{
		if v0 == i32(-1) {
			return
...
func (m *Module) fn253(v0, v1 int64, v2, v3 int32) int64 {
	var v4 int32
...
func (m *Module) fn254(v0, v1, v2, v3 int32) {
	var v4, v5 int32
	var v6, v7, v8 int64
		...
		}
		{
			...
			if uint32(v3) < uint32(t5) {
				...
				if t7 != 0 {
					...
					store32(m.memory[int64(uint32(v0))+12:], uint32(i32(1072978)))
				...
				l4:
					...
					v7 = int64(uint32(v2))
					{
							...
							{
								{
									...
									t15 := int64(load64(m.memory[int64(uint32(i32(0)))+1276608:]))
									v8 = t15
									v3 = int32(v8)
								...
								l8:
									...
									case 1:
										if v2&i32(255) == i32(37) {
											...
											store32(m.memory[int64(uint32(v4))+16:], uint32(i32(1069720)))
						...
						l9:
							t26 := int32(load32(m.memory[int64(uint32(i32(0)))+1069784:]))
							store32(m.memory[int64(uint32(v4))+140:], uint32(t26))
							t27 := int64(load64(m.memory[int64(uint32(i32(0)))+1069776:]))
...
func (m *Module) fn255(v0, v1, v2 int32) {
	var v3 int32
	var v4 int64
	var v5, v6, v7 int32
	var v8 int64
			...
			l19:
				...
				l2:
					...
					default:
						...
						m.fn124(i32(0), v6, i32(32), i32(1069496))
						panic("unreachable")
					case 2:
...
func (m *Module) fn256(v0, v1, v2, v3 int32) {
	var v4 int64
	var v5 int32
	var v6 int64
	var v7 int32
	...
	var v9, v10 int32
	{
		...
		default:
			...
			t21 := int64(load64(m.memory[int64(uint32(i32(0)))+1074953:]))
			store64(m.memory[int64(uint32(v1))+29:], uint64(t21))
			t22 := int64(load64(m.memory[int64(uint32(i32(0)))+1074948:]))
			store64(m.memory[int64(uint32(v1))+24:], uint64(t22))
			t23 := int64(load64(m.memory[int64(uint32(i32(0)))+1074940:]))
			store64(m.memory[int64(uint32(v1))+16:], uint64(t23))
			t24 := int64(load64(m.memory[int64(uint32(i32(0)))+1074932:]))
			store64(m.memory[int64(uint32(v1))+8:], uint64(t24))
			t25 := int64(load64(m.memory[int64(uint32(i32(0)))+1074924:]))
		...
		{
			{
				...
				v3 = t3
				{
					...
					default:
						...
						t16 := int64(load64(m.memory[int64(uint32(i32(0)))+1074953:]))
						store64(m.memory[int64(uint32(v3))+29:], uint64(t16))
						t17 := int64(load64(m.memory[int64(uint32(i32(0)))+1074948:]))
						store64(m.memory[int64(uint32(v3))+24:], uint64(t17))
						t18 := int64(load64(m.memory[int64(uint32(i32(0)))+1074940:]))
						store64(m.memory[int64(uint32(v3))+16:], uint64(t18))
						t19 := int64(load64(m.memory[int64(uint32(i32(0)))+1074932:]))
						store64(m.memory[int64(uint32(v3))+8:], uint64(t19))
						t20 := int64(load64(m.memory[int64(uint32(i32(0)))+1074924:]))
						...
						store32(m.memory[int64(uint32(v6))+4:], uint32(i32(1070212)))
...
func (m *Module) fn258(v0, v1 int32) int32 {
	...
	m.g0 = v2
	{
		...
		default:
			...
			t4 := int32(load32(m.memory[int64(uint32(i32(0)))+1273992:]))
			store32(m.memory[int64(uint32(v0))+16:], uint32(t4))
			t5 := int64(load64(m.memory[int64(uint32(i32(0)))+1273984:]))
			store64(m.memory[int64(uint32(v0))+8:], uint64(t5))
			t6 := int64(load64(m.memory[int64(uint32(i32(0)))+1273976:]))
			...
			t7 := int32(load32(m.memory[uint32(v1):]))
			t8 := int32(load32(m.memory[int64(uint32(v1))+4:]))
			t9 := m.fn49(t7, t8, i32(1066615), v2+i32(16))
			v0 = t9
		...
		case 1:
			...
			v0 = t16 << 2
			t17 := int32(load32(m.memory[int64(uint32(v0))+1290920:]))
			t18 := int32(load32(m.memory[int64(uint32(v0))+1290752:]))
			t19 := int32(load32(m.memory[int64(uint32(v1))+4:]))
	...
	l0:
		...
		v5 = t3
		{
			...
			}
			{
				...
				m.fn266(v0, i32(21), i32(1079848), i32(16))
				goto l1
			}
		l3:
			if uint32(v5) > uint32(v3) {
				m.fn124(i32(0), v5, v3, i32(1079864))
				panic("unreachable")
			}
			m.fn267(v1+i32(48), v2, v5)
			goto l2
		}
	l2:
		m.memory[uint32(v0)] = byte(i32(255))
		...
		{
			{
				...
				l10:
					...
					l1:
						...
						m.fn268(t14, t15, t16, t17, t18, t19, p21)
						...
						m.fn266(v4+i32(8), i32(20), i32(1069184), i32(22))
						goto l5
					}
				}
			l0:
						...
						{
							{
								...
								if uint32(v3) >= uint32(v9) {
									...
									m.fn265(v4+i32(8), v1+i32(56), v2, v3)
									goto l5
								}
							}
						l11:
...
l22:
	if uint32(v9) > uint32(v3) {
		m.fn124(i32(0), v9, v3, i32(1079864))
		panic("unreachable")
	}
	m.fn267(v1+i32(160), v2, v9)
	goto l21
l21:
	m.memory[uint32(v0)] = byte(i32(255))
	store32(m.memory[int64(uint32(v0))+4:], uint32(v9))
...
func (m *Module) fn263(v0 int32) {
	...
	l1:
		if v2 == 0 {
			...
			m.fn635(i32(1), v1+i32(12), i32(1277028), i32(1050185), v1+i32(16), i32(1277032))
			panic("unreachable")
		}
		if uint32(v2) >= uint32(i32(0x7fffffc1)) {
			m.fn45(i32(1284296), i32(43), v1+i32(31), i32(1284408), i32(1284424))
			panic("unreachable")
		}
					...
					l7:
						{
							...
							t23 := int32(load32(m.memory[int64(uint32((v12^v6)&i32(255)<<2))+1284456:]))
							t24 := v10
							v6 = int32(uint32(v6)>>8) ^ t23
							v10 = (t24+v6&i32(255))*i32(134775813) + i32(1)
							t25 := int32(load32(m.memory[int64(uint32((int32(uint32(v10)>>24)^v3&i32(255))<<2))+1284456:]))
...
func (m *Module) fn266(v0, v1, v2, v3 int32) {
	var v4 int32
	{
		t0 := m.fn11(v3)
		v4 = t0
	...
	l1:
		...
		store32(m.memory[int64(uint32(v3))+4:], uint32(i32(1092828)))
