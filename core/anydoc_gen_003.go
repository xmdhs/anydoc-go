...
func (m *Module) fn119(v0, v1, v2, v3, v4, v5 int32) {
	...
	m.g0 = v6
	{
		...
		l18:
			...
			m.fn121(v10, v1, v1, i32(1070116))
			panic("unreachable")
		l17:
			m.fn28(i32(1272348), i32(19), i32(1070100))
		l8:
			panic("unreachable")
		}
		v7 = v1
...
func (m *Module) fn121(v0, v1, v2, v3 int32) {
	...
	if uint32(v0) > uint32(v2) {
		...
		m.fn28(i32(1050499), v4+i32(16), v3)
		panic("unreachable")
	}
	if uint32(v1) > uint32(v2) {
		...
		store64(m.memory[int64(uint32(v4))+16:], uint64(v5|int64(uint32(v4+i32(8)))))
		m.fn28(i32(1050556), v4+i32(16), v3)
		panic("unreachable")
	}
	v5 = int64(uint32(i32(3))) << 32
	...
	store64(m.memory[int64(uint32(v4))+24:], uint64(v5|int64(uint32(v4+i32(12)))))
	store64(m.memory[int64(uint32(v4))+16:], uint64(v5|int64(uint32(v4+i32(8)))))
	m.fn28(i32(1049756), v4+i32(16), v3)
	panic("unreachable")
}
func (m *Module) fn122() {
	m.fn28(i32(1120144), i32(153), i32(1120220))
	panic("unreachable")
}
